...
| 2026-02-23T07:00:00+00:00 | chore/cleanup-446mb-binaries-and-zombie-configs | all | Phase 1: Emergency cleanup - removed 446 MB stale binaries (integration.test 192MB, nephio-bridge 100MB, main 75MB, llm-processor 64MB, controllers.test 15MB) + comprehensive technical debt analysis document |
| 2026-02-23T07:01:00+00:00 | chore/cleanup-446mb-binaries-and-zombie-configs | config | Phase 2: Zombie config cleanup - removed 8 never-used configs (.gosec.json, .pre-commit-config.yaml, .nancy-ignore, .markdownlint.json, .yamllint.yml, .sops.yaml, docker-compose.ollama.yml, .env.ollama.example) |
| 2026-02-23T07:02:00+00:00 | chore/cleanup-446mb-binaries-and-zombie-configs | metadata | Fixed PROJECT metadata repo path (nephio-project/nephoran → thc1006/nephoran-intent-operator), created ADR 002 documenting all cleanup decisions |
| 2026-02-23T07:03:00+00:00 | main | ci | PR #355 merged: Massive cleanup achieved 27% repo size reduction (1.5GB → 1.1GB), eliminated 800+ lines dead code, fixed CI root-allowlist validation |
| 2026-02-23T07:15:00+00:00 | chore/cleanup-root-directory-all-phases | docs | Phase 1: Removed outdated PR descriptions (PR_PHASE1_DESCRIPTION.md 251 lines, PR_PHASE1_UPDATED.md 397 lines, CLAUDE_AGENTS_ANALYSIS.md 279 lines from 6 months ago) |
| 2026-02-23T07:16:00+00:00 | chore/cleanup-root-directory-all-phases | docs | Phase 2: Deleted 100% outdated CHANGELOG.md (missing 30+ commits), created .github/release.yml for auto-generated GitHub release notes |
| 2026-02-23T07:17:00+00:00 | chore/cleanup-root-directory-all-phases | docs | Phase 3: Moved QUICKSTART_OLLAMA.md → docs/deployment/ollama-setup.md for better documentation organization |
