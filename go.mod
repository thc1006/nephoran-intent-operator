...
require (
	...
	github.com/thc1006/nephoran-intent-operator/api v0.0.0-00010101000000-000000000000 // indirect
	github.com/thc1006/nephoran-intent-operator/pkg v0.0.0-00010101000000-000000000000 // indirect
...
// Replace specific local modules
replace (
	...
	github.com/thc1006/nephoran-intent-operator/pkg/performance => ./pkg/performance
)
