...
require (
	...
	github.com/thc1006/nephoran-intent-operator/pkg/controllers/interfaces v0.0.0-00010101000000-000000000000
	github.com/thc1006/nephoran-intent-operator/pkg/rag v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/thc1006/nephoran-intent-operator/pkg/errors v0.0.0-00010101000000-000000000000 // indirect
...
// Enforce Kubernetes version compatibility - all k8s packages must use v0.34.0
replace (
