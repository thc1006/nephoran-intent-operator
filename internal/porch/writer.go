...
// WriteIntentSimple writes the intent to the output directory in simplified format
func WriteIntentSimple(intent interface{}, outDir string, format string) error {
