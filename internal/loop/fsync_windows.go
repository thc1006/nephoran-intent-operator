...
func isRetryableError(err error) bool {
	...
	const (
		...
		// ERROR_SHARING_VIOLATION holds error_sharing_violation value.

		ERROR_SHARING_VIOLATION = 32

		// ERROR_LOCK_VIOLATION holds error_lock_violation value.

		ERROR_LOCK_VIOLATION = 33

		// ERROR_ACCESS_DENIED holds error_access_denied value.

		ERROR_ACCESS_DENIED = 5

		// ERROR_FILE_NOT_FOUND holds error_file_not_found value.

		ERROR_FILE_NOT_FOUND = 2

		// ERROR_PATH_NOT_FOUND holds error_path_not_found value.
