...
const (
	...
	// LoadLevelLow holds loadlevellow value.

	LoadLevelLow LoadLevel = "LOW" // < 30%

	// LoadLevelModerate holds loadlevelmoderate value.

	LoadLevelModerate LoadLevel = "MODERATE" // 30-70%

	// LoadLevelHigh holds loadlevelhigh value.

	LoadLevelHigh LoadLevel = "HIGH" // 70-85%

	// LoadLevelCritical holds loadlevelcritical value.
