...
func NewWorkflowEngine(config *OrchestrationConfig, logger logr.Logger) *WorkflowEngine { return &WorkflowEngine{} }
func (w *WorkflowEngine) Start() error { return nil }
func (w *WorkflowEngine) Stop() {}

func NewResourceManager(config *OrchestrationConfig, logger logr.Logger) *ResourceManager { return &ResourceManager{} }
func (r *ResourceManager) CheckQuotas(reqs ResourceRequirements, clusters []string) error { return nil }

func NewPackageManager(config *OrchestrationConfig, logger logr.Logger) *PackageManager { return &PackageManager{} }
...
func NewStateManager(config *OrchestrationConfig, logger logr.Logger) *StateManager { return &StateManager{} }
func NewTransactionManager(config *OrchestrationConfig, logger logr.Logger) *TransactionManager { return &TransactionManager{} }

func NewNephioClient(config *OrchestrationConfig, logger logr.Logger) *NephioClient { return &NephioClient{} }
func (n *NephioClient) Connect() error { return nil }
func (n *NephioClient) Disconnect() {}

func NewORANAdaptor(config *OrchestrationConfig, logger logr.Logger) *ORANAdaptor { return &ORANAdaptor{} }
func NewPipelineManager(config *OrchestrationConfig, logger logr.Logger) *PipelineManager { return &PipelineManager{} }

func NewMetricsCollector(config *OrchestrationConfig, logger logr.Logger) *MetricsCollector { return &MetricsCollector{} }
func (m *MetricsCollector) RecordGauge(name string, value float64) {}

func NewTraceManager(config *OrchestrationConfig, logger logr.Logger) *TraceManager { return &TraceManager{} }
func NewAuditLogger(config *OrchestrationConfig, logger logr.Logger) *AuditLogger { return &AuditLogger{} }