...
const (
	...
	// MessageTypeData holds messagetypedata value.

	MessageTypeData uint8 = 0x01

	// MessageTypeHandshake holds messagetypehandshake value.

	MessageTypeHandshake uint8 = 0x02

	// MessageTypeHeartbeat holds messagetypeheartbeat value.

	MessageTypeHeartbeat uint8 = 0x03

	// MessageTypeRekey holds messagetyperekey value.
