...
func (n *NoOpCertificateProvider) IssueCertificate(ctx context.Context, service, namespace string) (*x509.Certificate, error) {
...
func (n *NoOpCertificateProvider) RotateCertificate(ctx context.Context, service, namespace string) (*x509.Certificate, error) {
