...
func (p *PredefinedExperiments) GetPodChaosExperiment(targetNamespace, killMode string) *Experiment {
...
func (p *PredefinedExperiments) GetGameDayScenario(scenarioType, targetNamespace string) *GameDayScenario {
