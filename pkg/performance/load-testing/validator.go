...
// DefaultPerformanceValidator validates performance claims against test results
type DefaultPerformanceValidator struct {
...
func NewPerformanceValidator(config *LoadTestConfig, logger *zap.Logger) PerformanceValidator {
	...
	validator := &DefaultPerformanceValidator{
		config: config,
		logger: logger,
		thresholds: ValidationThresholds{
...
func (v *DefaultPerformanceValidator) Validate(results *LoadTestResults) ValidationReport {
...
func (v *DefaultPerformanceValidator) ValidateRealtime(metrics GeneratorMetrics) bool {
	// Check error rate
...
func (v *DefaultPerformanceValidator) GetThresholds() ValidationThresholds {
	return v.thresholds
}

// Private validation methods

func (v *DefaultPerformanceValidator) validateConcurrentIntents(results *LoadTestResults, report *ValidationReport) {
...
func (v *DefaultPerformanceValidator) validateThroughput(results *LoadTestResults, report *ValidationReport) {
...
func (v *DefaultPerformanceValidator) validateLatency(results *LoadTestResults, report *ValidationReport) {
...
func (v *DefaultPerformanceValidator) validateAvailability(results *LoadTestResults, report *ValidationReport) {
...
func (v *DefaultPerformanceValidator) validateResourceUsage(results *LoadTestResults, report *ValidationReport) {
	evidence := Evidence{
		Type:        "resource_usage",
...
func (v *DefaultPerformanceValidator) validateStatisticalSignificance(results *LoadTestResults, report *ValidationReport) {
...
func (v *DefaultPerformanceValidator) initializeTests() {
...
func (v *DefaultPerformanceValidator) calculateMaxConcurrent(results *LoadTestResults) int {
...
func (v *DefaultPerformanceValidator) calculateScore(report *ValidationReport) float64 {
	score := 100.0
...
func (v *DefaultPerformanceValidator) generateRecommendations(results *LoadTestResults, report *ValidationReport) {
...
func chiSquareCDF(x float64, df float64) float64 {
	// Chi-square CDF calculation using distuv package
