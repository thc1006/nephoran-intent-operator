...
const (
	// L1CacheLevel holds l1cachelevel value.
	L1CacheLevel CacheLevel = iota + 1 // In-memory local cache
	// L2CacheLevel holds l2cachelevel value.
	L2CacheLevel // Distributed Redis cache
	// L3CacheLevel holds l3cachelevel value.
...
const (
	...
	// EvictionFIFO holds evictionfifo value.
...
const (
	// CacheKeyLLMResponse holds cachekeyllmresponse value.
	CacheKeyLLMResponse = "llm:response:%s" // intent hash
	// CacheKeyRAGContext holds cachekeyragcontext value.
	CacheKeyRAGContext = "rag:context:%s" // query hash
	// CacheKeyResourcePlan holds cachekeyresourceplan value.
	CacheKeyResourcePlan = "resource:plan:%s" // plan hash
	// CacheKeyManifestTemplate holds cachekeymanifesttemplate value.
	CacheKeyManifestTemplate = "manifest:template:%s" // template hash
	// CacheKeyGitCommit holds cachekeygitcommit value.
	CacheKeyGitCommit = "git:commit:%s" // manifest hash
	// CacheKeyDeploymentStatus holds cachekeydeploymentstatus value.
	CacheKeyDeploymentStatus = "deployment:status:%s" // deployment hash
	// CacheKeyTelecomKnowledge holds cachekeytelecomknowledge value.
