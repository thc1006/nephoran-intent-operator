...
func (c *L2Cache) Get(ctx context.Context, key string) (interface{}, error) { return nil, fmt.Errorf("not implemented") }
func (c *L2Cache) Set(ctx context.Context, key string, value interface{}, ttl time.Duration) error { return nil }
...
func (c *L3Cache) Get(ctx context.Context, key string) (interface{}, error) { return nil, fmt.Errorf("not implemented") }
func (c *L3Cache) Set(ctx context.Context, key string, value interface{}, ttl time.Duration) error { return nil }
