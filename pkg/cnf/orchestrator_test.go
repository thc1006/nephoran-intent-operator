			...
			cnfDeployment = &nephoranv1.CNFDeployment{
				...
				Spec: nephoranv1.CNFDeploymentSpec{
					...
					Resources: nephoranv1.CNFResources{
						CPU:       mustParseQuantity("1000m"),
						Memory:    mustParseQuantity("2Gi"),
						Storage:   mustParseQuantityPtr("10Gi"),
						MaxCPU:    mustParseQuantityPtr("2000m"),
						MaxMemory: mustParseQuantityPtr("4Gi"),
					},
				},
			}
...
func (m *MockGitClient) GetFileContent(filePath string) ([]byte, error) {
