...
func (mr *MockLLMClientMockRecorder) ProcessIntent(ctx, request interface{}) *gomock.Call {
...
func (mr *MockLLMClientMockRecorder) GenerateNetworkConfig(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLLMClientMockRecorder) ValidateIntent(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
