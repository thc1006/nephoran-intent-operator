...
// Source: pkg/llm/client.go
//
// Generated by this command:
//
//	mockgen -source=pkg/llm/client.go -destination=pkg/llm/mocks/client_mock.go -package=mocks
//
...
import (
	...
	llm "github.com/thc1006/nephoran-intent-operator/pkg/llm"
...
func (m *MockLLMClient) GenerateNetworkConfig(ctx context.Context, request *llm.NetworkConfigRequest) (*llm.NetworkConfigResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateNetworkConfig", ctx, request)
	ret0, _ := ret[0].(*llm.NetworkConfigResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLLMClient) ProcessIntent(ctx context.Context, request *llm.ProcessIntentRequest) (*llm.ProcessIntentResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessIntent", ctx, request)
	ret0, _ := ret[0].(*llm.ProcessIntentResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLLMClient) ValidateIntent(ctx context.Context, request *llm.ValidateIntentRequest) (*llm.ValidateIntentResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateIntent", ctx, request)
	ret0, _ := ret[0].(*llm.ValidateIntentResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
