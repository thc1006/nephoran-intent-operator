...
func (r *SimpleRBACEngine) Authorize(ctx context.Context, user *User, resource, action string) (bool, error) {
...
func (r *SimpleRBACEngine) AssignRole(ctx context.Context, userID, roleName string) error {
